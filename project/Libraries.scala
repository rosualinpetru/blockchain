...
object Libraries {
  ...
  lazy val cats = "org.typelevel" %% "cats-core" % "2.10.0" withSources ()
  ...
  lazy val logback = "ch.qos.logback" % "logback-classic" % "1.4.11" withSources ()

  lazy val log4cats = "org.typelevel" %% "log4cats-slf4j" % "2.6.0" withSources ()

  lazy val sourcecode = "com.lihaoyi" %% "sourcecode" % "0.3.1" withSources ()
}
